...
function setAnimationTime() {
    var travelTime = 3500; //ms
    var ball = document.getElementById("ball");
    var windowWidth = window.innerWidth + ball.getBoundingClientRect().width;
    var ballCirc = ball.getBoundingClientRect().width * Math.PI * 0.95;
    var rotateTime = travelTime / (windowWidth / ballCirc);
  
    ball.style.animationDuration = rotateTime + "ms, " + travelTime + "ms";
  }
